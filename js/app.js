(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".rooms-page__slider")) new core(".rooms-page__slider", {
            modules: [ Navigation, Pagination ],
            observer: true,
            slidesPerView: 1,
            spaceBetween: 30,
        ...
        if (document.querySelector(".tips-page__slider")) new core(".tips-page__slider", {
            modules: [ Navigation, Pagination ],
            observer: true,
            slidesPerView: 1,
            spaceBetween: 30,
    ...
    document.addEventListener("click", (e => {
        ...
        if (e.target.closest(".search-header__button")) document.querySelector(".search-header__form").classList.toggle("_active");
        if (!e.target.closest(".search-header__form") && !e.target.closest(".search-header__button")) document.querySelector(".search-header__form").classList.remove("_active");
        ...
        if (target.closest(".cart")) {
            if (document.querySelector(".cart__list").children.length > 0) document.querySelector(".cart__list").classList.add("_active");
        } else if (!target.closest(".cart") && !target.closest(".products-page__button")) document.querySelector(".cart__list").classList.remove("_active");
    ...
    function updateCart(productButton, targetId, productAdd = true) {
        ...
        if (productAdd) {
            if (cartQuantity) cartQuantity.innerHTML = ++cartQuantity.innerHTML; else cartIcon.insertAdjacentHTML("beforeend", ` <span classs="cart__value">1</span>`);
            if (!cartProduct) {
            ...
            if (!parseInt(cartProudctValue.innerHTML)) cartProduct.remove();
